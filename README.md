...
This R Shiny application helps users find the cheapest combination of foods that meet their daily nutritional requirements. By using linear programming, particularly the Simplex Method, we can apply this to any number of food items, nutritional restrictions, and serving count limitations.
